...
审阅对象：[seed-cards.json](./cards/seed-cards.json) 与 [phase5-batch-02.json](./cards/phase5-batch-02.json)。当前 95 张卡片已全部依据产品决定标为 `approved`。
...
同义词表、安全规则和安全回答文案需要分别审核；它们的状态不会随卡片审核自动改变。完成后运行：
